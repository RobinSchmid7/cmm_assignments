...
public:
    ...
    void drawImGui() override {
        ...
        SliderInt("# initial boids", &n, 1, 100, "%i", ImGuiSliderFlags_Logarithmic);
        SliderFloat("Timestep", &timestep, 0.001f, 1.0f, "%.5f", ImGuiSliderFlags_Logarithmic);
        End();
        ...
        SliderFloat("Cohesion radius", &cohesionRadius, 0.0f, 1.0f, "%.5f", 5);
        SliderFloat("Alignment radius", &alignmentRadius, 0.0f, 1.0f, "%.5f", 5);
        SliderFloat("Separation radius", &separationRadius, 0.0f, 1.0f, "%.5f", 5);
        SliderFloat("Boid mass", &boidMass, 0.01f, 10.0f, "%.5f", ImGuiSliderFlags_Logarithmic);
        SliderFloat("Damping", &damping, -1.0f, 1.0f, "%.5f", 5);
        SliderFloat("Friction", &friction, 0.0f, 10.0f, "%.5f", 5);
        SliderFloat("Leader observation", &leaderObservationDistance, 0.0f, 1.0f, "%.5f", 5);
        SliderFloat("Leader approach stop", &stopApproachLeaderRadius, 0.0f, 0.1f, "%.5f", 5);
        End();
        ...
        SliderFloat("Breeding radius", &breedingRadius, 0.0f, 1.0f, "%.5f", ImGuiSliderFlags_Logarithmic);
        SliderFloat("Elimination radius", &eliminationRadius, 0.0f, 1.0f, "%.5f", ImGuiSliderFlags_Logarithmic);
        SliderInt("Max # boids per iteration", &maxNumNewBreeded, 0, 5, "%i", ImGuiSliderFlags_Logarithmic);
        SliderInt("Breeding pause steps", &breedingPauseSteps, 10, 1000, "%.5f", ImGuiSliderFlags_Logarithmic);
        SliderFloat("Hunter group size", &hunterGroupSize, 0.01, 0.5f, "%.5f", ImGuiSliderFlags_Logarithmic);
        SliderInt("Max # of boids", &maxNumParticles, 1, 1000, "%i", ImGuiSliderFlags_Logarithmic);
        End();
    }
...
int main(int, char**)
{
    int width = 1000; // Default: 720
    int height = 1000; // Default: 720
